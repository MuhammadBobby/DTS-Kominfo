...
$jurusan = array('TEKNIK INFORMATΙΚΑ', 'TEKNIK ELEKTRO', 'REKAMEDIS');
    ...
    <form method="post" action="update.php">
        ...
        <table>
            ...
            <tr>
                <td>JENIS KELAMIN</td>
                <td>
                    <input type="radio" name="jenis_kelamin" value="l" <?php echo active_radio_button("l", $row['jenis_kelamin']) ?>>Laki Laki <input type="radio" name="jenis_kelamin" value="p" <?php echo active_radio_button("p", $row['jenis_kelamin']) ?>>Perempuan
                </td>
            </tr>
            tr><td>JURUSAN <?php echo $row['jurusan']; ?></td>
            <td>
